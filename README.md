...
The Desk was chosen from a side-by-side design comparison (Desk, Editorial, and Machine variants behind `?poc=1`); that shell is preserved at the `design-poc-final` git tag.
